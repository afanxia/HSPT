...
public enum StatusCode {
    ...
    LANG_NOT_FOUND(502, "参数【语言】不能为空"),
    VERSION_NOT_FOUND(503, "参数【客户端版本】不能为空"),
    PLATFORM_NOT_FOUND(504, "参数【来源平台】不能为空"),
    ACCOUNT_NOT_FOUND(505, "账号不存在"),
    TOKEN_NOT_FOUND(506, "Token不能为空"),
    TOKEN_HEAD_NOT_FOUND(507, "TokenHead不能为空"),
