...
import org.hspt.common.utils.JWT_Utils;
...
import org.hspt.entity.request.Token;
import org.hspt.entity.response.ResToken;
import org.hspt.remote.UserRemote;
...
public class PubServiceImpl extends BaseService implements PubService {
    ...
    public BaseResponse refresh(String token) {
        if (null == token) {
            throw new BaseException(StatusCode.TOKEN_NOT_FOUND);
        }
        //刷新生成新的TOKEN
