...
import org.hspt.base.BaseMongoEntity;

/**
 * <b> 异常信息存储实体类 </b>
 * <p>
 * 功能描述:存储系统出现异常的时候的错误信息，索引建立原则为先筛选，后排序，最后放多余条件
 * </p>
 */
@CompoundIndexes({
...
@ApiModel("异常日志信息")
@Entity
public class ErrorInfo extends BaseMongoEntity {
