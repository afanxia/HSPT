...
import org.hspt.dao.jpa.AuthorizationDAO;
import org.hspt.entity.jpa.HsptAuthorization;
import org.hspt.utils.AESUtil;
import org.hspt.utils.DateUtils;
import org.hspt.utils.ReflectionUtils;
import org.hspt.utils.SnowflakeIdWorker;
...
public class Pub_Tools {
    ...
    public boolean checkOtherToken(String token) {
        ...
        if (StrUtil.isNotBlank(tokenStr)) {
            ...
            //根据条件从数据库查询数据
            HsptAuthorization authorization = authorizationDAO.findByAccessKeyAndSecretKey(accessKey, secretKey);
